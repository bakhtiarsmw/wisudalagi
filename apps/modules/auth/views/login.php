...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url(<?=base_url('../assets/app/media/img//bg/bg-2.jpg')?>);">
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
                        <img src="<?=base_url('../assets/app/media/img//logos/log-unmer-malang-kuning.png')?>">
                    </a>
                </div>
                <div class="m-login__signin">
                    ...
                    <div id="infoMessage" style="color:#ffffff !important;text-align:center;"><?=$message;?></div>
                    <?php $attributes = array('class' => 'm-login__form m-form'); $attrBtn = array('id' => 'm_login_signin_submit'); ?>
                    ...
                    <div class="m-login__form-action">
                        <?=form_submit('submit', lang('login_submit_btn'),'btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air');?>
                    </div>
                    <?=form_close();?>
                </div>
